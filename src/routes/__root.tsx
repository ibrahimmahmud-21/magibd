...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The definitive ranking platform for influential and notable people across various categories." },
      { property: "og:title", content: "Magi BD — Prestigious Rankings & Lists" },
      { property: "og:description", content: "The definitive ranking platform for influential and notable people across various categories." },
